  ...
  return (
    <div className="h-full w-full">
      ...
      <div className="hidden md:flex flex-col h-full items-center justify-center text-muted-foreground p-8 text-center bg-white/30 backdrop-blur-3xl">
        ...
        <h2 className="text-3xl font-bold text-foreground mb-3 tracking-tight">Chào mừng đến với CRChat</h2>
        <p className="max-w-md text-muted-foreground/80 text-lg">Chọn một cuộc trò chuyện từ thanh bên hoặc bắt đầu cuộc trò chuyện mới để nhắn tin.</p>
      </div>
    </div>
  );
}